...
def load_training_objects(args):
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=0, pin_memory=True, sampler=train_sampler, prefetch_factor=2)
...
def train(train_loader, model, criterion, optimizer, epoch, device_id, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        images = images.cuda(device_id, non_blocking=False)
        target = target.cuda(device_id, non_blocking=False)

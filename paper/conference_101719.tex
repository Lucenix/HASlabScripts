...
% Non-Machine Learning Observation through eBPFs
In terms of eBPF, there are some tools that are able to be used for system tracing and performance analysis,
such as DIO \cite{DIO} that allow the observation of I/O interactions between the application and in-kernel storage,
\cite{CAT} which is able to correlate the flow of storage and netowork requests applcation and \cite{tracee} that provides runtime security and forensics.  

% eBPFs in Kernel-Level Machine Learning analysis

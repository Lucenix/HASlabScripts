...
\section{Background}
    ...
    To facilitate the creation, compilation and execution of eBPF programs, bpftrace \cite{bpftrace}, a high-level tracing language inspired in DTrace, can be used in conjunction to a collection of tools, some are also present in \cite{bgreggBook}.
\begin{itemize}

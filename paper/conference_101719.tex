...
We analyzed the training of the resnet50 \cite{resnet50} and alexnet \cite{resnet50} models
provided by \textit{PyTorch} on a machine with a Intel(R) Core(TM) i9-9900K CPU @ 3.60GHz

...
\begin{itemize}
    ...
    \end{itemize}
    \item I/O Characterization has produced diverse assumptions about DL I/O behaviour, like high overhead for random reads, which are commonly used to justify various types of optimization explorations (\cite{10.1145/3331526}, \cite{8891023}, \cite{10.1145/3337821.3337902}). Quality and specific storage characterization are required to find unique and worthwhile solutions for newer performance problems. 
...
\begin{itemize}
    ...
    \item Descrever o I/O pipeline do Tensorflow workloads através da sua definição teórica para benchmark \cite{8638422}
    \item Caracterizar LMDB, a \textbf{database} usada como base do Caffe, baseada em \textit{mmap} e numa \textit{B+-tree}. \cite{10.1145/3331526}
    \item dUtilizar NVMe over Fabrics para OS-bypass 
